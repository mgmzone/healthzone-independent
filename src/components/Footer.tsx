  ...
  return (
    <footer className="bg-background border-t py-8 mt-auto">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
          <div className="col-span-1 md:col-span-2">
            <Link to="/" className="flex items-center space-x-2">
              <div className="font-bold text-2xl gradient-text">HealthZone</div>
            </Link>
            <p className="mt-3 text-muted-foreground text-sm max-w-md">
              Track your health journey with precision. Monitor weight, fasting, and exercise in one seamless experience.
            </p>
          </div>
        ...
        <div className="border-t mt-8 pt-6 flex flex-col-reverse sm:flex-row justify-between items-center">
