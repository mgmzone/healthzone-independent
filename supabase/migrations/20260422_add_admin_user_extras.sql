-- Migration: Admin RPC to fetch per-user signup date, feature flags, and AI usage
-- Date: 2026-04-16
-- Security-definer so admin callers can read across users; auth.uid() still
-- must match an is_admin=true profile to proceed.
